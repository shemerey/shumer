...
function! ctrlp_bdelete#mappings(...)
  ...
  nnoremap <buffer> <silent> <D-2> :call <sid>DeleteMarkedBuffers()<cr>
  nnoremap <buffer> <silent> <D-@> :call <sid>DeleteMarkedBuffers()<cr>
endfunction
...
call ctrlp_bdelete#init()                 " enable buffer delete
